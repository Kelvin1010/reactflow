...
function BarGroupChart({ onCallback, id }) {
    ...
    useEffect(() => {
        ...
        var output =  barGroupChartTransform(atomParent.data.output, initialInput);
    ...
    function handleChangeInput(event) {
        ...
        var output =  barGroupChartTransform(atomParent.data.output, { ...input, [name]: value });
...
function barGroupChartTransform(input, { xColumn, yColumn, zColumn }) {
