...
function MultipleLinePlotAnimation({ onCallback, id }) {
    ...
    useEffect(() => {
        ...
        var output = multipleLinePlotAnimationTransform(atomParent.data.output, initialInput);
    ...
    function handleChangeInput(event) {
        ...
        var output = multipleLinePlotAnimationTransform(atomParent.data.output, { ...input, [name]: value });
...
function multipleLinePlotAnimationTransform(input, { xColumn, yColumn, zColumn }) {
